...
Ainsi, ce ne sont pas des particules, mais des groupes de particules qui sont représentés, c'est pourquoi ce sera une physique probabiliste et non déterministe qui sera utilisée.

Comme expliqué dans la section [-@sec-lbmh], la méthode LBM ne repose pas sur les équations de Navier-Stokes [-@sec-NSE], mais sur les équations de Boltzmann [-@sec-BE], utilisées et adaptées pour résoudre les équations de Navier-Stokes [-@sec-NSE].
...
Les équations alors utilisées ne sont pas les équations de Navier-Stokes @sec-NSE, mais les équations de Boltzmann.
...
Dans les équations de Navier-Stokes @sec-NSE, on a le temps et la position comme variable, mais dans la méthode LBM, on prend également la vélocité des molécules comme une variable.
